...
int leastInterval(vector<char> &tasks, int n)
{
    ...
    {
        hash[tasks[i] - 'A']++;
        if (hash[tasks[i] - 'A'] > maxFreq)
        {
            maxFreq = hash[tasks[i] - 'A'];
        }
    }
